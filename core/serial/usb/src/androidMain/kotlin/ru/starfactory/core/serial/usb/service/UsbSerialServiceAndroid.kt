...
import ru.starfactory.core.serial.usb.domain.UsbSerialDeviceAndroid
import ru.starfactory.core.usb.service.UsbServiceAndroid
import ru.starfactory.core.usb.service.toUsbDevice
import java.io.IOException
import android.hardware.usb.UsbDevice as UsbDeviceAndroid


internal interface UsbSerialServiceAndroid {
...
internal class UsbSerialServiceAndroidImpl(
    private val usbService: UsbServiceAndroid,
    ...
    private val usbSerialDevicesObservable: Flow<Map<String, UsbSerialDeviceAndroid>> =
    ...
    private fun Map<String, UsbDeviceAndroid>.toUsbSerialDevices() =
        mapValues { UsbSerialDeviceAndroid(it.value.toUsbDevice(), it.value, prober.probeDevice(it.value)) }
...
//    }
    ...
    companion object {
        private const val TAG = "USB_SERIAL"
    }
